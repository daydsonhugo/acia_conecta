...
export function BoardCard({ member }: BoardCardProps) {
  return (
    <article className="overflow-hidden rounded-[2rem] border border-conecta-100 bg-white shadow-panel transition duration-300 hover:-translate-y-1 hover:shadow-soft">
      ...
      <div className="p-6">
        ...
        <p className="mt-5 text-sm leading-7 text-conecta-700">{member.bio}</p>
      </div>
    </article>
  );
}
